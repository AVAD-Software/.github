...
안심·교육·복지 서비스를 개발하는 AVAD-Software 조직 프로필
...
| 유형 | 사용 범위 | 제목 형식 |
| --- | --- | --- |
| 기능 추가 | 신규 기능 및 사용자 요구사항 | `[기능] 기능명` |
| 버그 수정 | 오류 및 예외 동작 | `[버그] 문제명` |
| 개선 작업 | 사용성·성능·구조 개선 | `[개선] 개선 내용` |
| 일반 작업 | 문서·설정·기술 부채·운영 작업 | `[작업] 작업 내용` |
